...
import { applyTheme, nextTheme, useSystemTheme, useTheme } from '../theme'
...
export function ThemeToggle() {
  ...
  return <button type="button" className="sidebar-theme-toggle" aria-label={label} title={label} onClick={() => applyTheme(next)}>
